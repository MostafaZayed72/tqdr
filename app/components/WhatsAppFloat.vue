<template>
  ...
  >
    ...
    <!-- Icon -->
    <div class="w-14 h-14 bg-[#25D366] rounded-2xl shadow-xl shadow-green-500/20 flex items-center justify-center hover:scale-110 hover:-rotate-12 transition-all duration-300">
